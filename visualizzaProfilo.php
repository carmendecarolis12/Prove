...
if (isset($_SESSION['MM_Username'])) {
  $colname_Recordset1 = sprintf($_SESSION['MM_Username']);
}
mysql_select_db($database_dbConnect, $dbConnect);
...
if (isset($_GET['totalRows_Recordset8'])) {
		$whitelist = array('pageNum_Recordset8');
$site = 'pageNum_Recordset8'; # Example string to test against
if( in_array($site,$whitelist) )
{
    echo $site.'pageNum_Recordset8';
}
else
{
