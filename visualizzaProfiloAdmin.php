...
if (isset($_GET['totalRows_Recordset9'])) {
		$whitelist = array('pageNum_Recordset9');
$site = 'pageNum_Recordset9'; # Example string to test against
if( in_array($site,$whitelist) )
{
    echo $site.'pageNum_Recordset9';
}
else
{
